# Generated by Django 2.0.6 on 2018-07-08 06:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('blogweb', '0002_auto_20180707_1519'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogweb.Category', verbose_name='分类'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(blank=True, to='blogweb.Tag', verbose_name='标签集合'),
        ),
    ]
